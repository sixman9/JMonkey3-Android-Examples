...
public class Game10 extends SimpleApplication implements TouchListener,AnimEventListener,PhysicsCollisionListener {
  ...
  public static void createPhysicsTestWorld(Node rootNode, AssetManager assetManager, PhysicsSpace space) {
      ...
      material.setTexture("ColorMap", assetManager.loadTexture("Textures/Terrain/Rock/Rock.PNG"));
